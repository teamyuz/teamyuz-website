...
const schedule = [
  { date: '2026.11.7', title: '상주 생명과학고등학교 공연', venue: '상주 생명과학고등학교 (경북)' },
  { date: '2026.10.24', title: '남포동 발코니 음악회 공연', venue: '남포동 (부산)' },
  { date: '2026.10.10~11', title: '여수 거문도 공연 2회차', venue: '거문도 (여수)' },
  { date: '2026.10.7', title: '함양 산삼축제 공연', venue: '함양 (경남)' },
  { date: '2026.9.30', title: '대구 동중학교 학생 힐링 공연', venue: '대구 동중학교' },
  { date: '2026.9.15', title: '대구 북구 창조캠퍼스 공연', venue: '창조캠퍼스 (대구 북구)' },
  { date: '2026.9.11', title: '대구 동성로 인디053 공연', venue: '인디053 (대구 동성로)' },
  { date: '2026.9.6', title: '대구 북구 수상한 시네마 공연', venue: '동화천 광장 (대구 북구)' },
  { date: '2026.9.5', title: '제13회 김천 산내들 한여름 밤의 음악회 공연', venue: '부항댐 산내들공원 (김천)' },
  { date: '2026.9.4', title: '동서화합 문화예술관광 박람회 공연', venue: '동성로 28아트스퀘어 (대구)' },
  { date: '2026.8.29~30', title: '여수 거문도 공연 1회차', venue: '거문도 (여수)' },
  { date: '2026.8.5', title: '영남대 천마아트홀 공연', venue: '천마아트홀 그랜드홀 (영남대)' },
  { date: '2026.8.2', title: '거제 한화 벨버디어 호텔 공연', venue: '한화 벨버디어 호텔 (거제)' },
      ...
      grid.innerHTML = data.items.slice(0, 3).map(item => {
        ...
        return `<a class="blog-card" href="${item.link}" target="_blank" rel="noopener">
          <div class="blog-card-thumb">
            ${thumb ? `<img src="${thumb}" alt="${item.title}" loading="lazy" />` : `<div class="blog-card-thumb-ph">📝</div>`}
          </div>
